...
urlpatterns = [
    ...
    path('payment_entry/',views.cash_entry,name='cash_entry'),
    path('payment_report/',views.cash_report,name='cash_report'),
    path('payment_edit/<int:id>',views.cash_entry_edit,name='cash_edit'),
    path('payment_delete/<int:id>',views.cash_delete,name='cash_delete')
